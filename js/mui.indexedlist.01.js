...
(function($, window, document) {
	...
	var IndexedList = $.IndexedList = $.Class.extend({
		...
		findElements: function() {
			...
			self.el.otherDiv=self.box.querySelector(classSelector('indexed-list-other'));
		...
		caleLayout: function() {
			...
			if(self.el.otherDiv!=null)
			otherdivHeight=self.el.otherDiv.offsetHeight;
			var withoutSearchHeight = (self.box.offsetHeight - self.el.search.offsetHeight-otherdivHeight) + 'px';
			self.el.bar.style.height = withoutSearchHeight;
			self.el.inner.style.height = withoutSearchHeight;
			var barItemHeight = (withoutSearchHeight / self.el.barItems.length) + 'px';
